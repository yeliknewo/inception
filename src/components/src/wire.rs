...
impl Component {
    pub fn new(input: Link, output: Link, me: Link) -> Component {
        Component {
            input: input,
            output: output,
            me: me,
    ...
    pub fn new_from_points(input: Point3I, output: Point3I, me: Point3I) -> Component {
        Component::new(Link::new(input), Link::new(output), Link::new(me))
    }
